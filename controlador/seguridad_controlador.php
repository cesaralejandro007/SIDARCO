    ...
    public function get_info_permisos()
    {
        ...
        foreach ($usuarios as $u) {
            ...
            $retornar[] = [
                ...
                "estado"         => $estado,
                "rol"            => $u['rol_inicio'],
                "editar"         => "<button class='btn btn-success' onclick='modificar_rol(`" . $u['rol_inicio'] . "`,`" . $this->Decodificar($u['contrasenia']) . "`,`" . $u['cedula_persona'] . "`)' title='Modificar rol o clave de usuario'><span class='fa fa-edit' type='button'></span></button>",
