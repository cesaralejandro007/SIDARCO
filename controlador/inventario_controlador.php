...
class Inventario extends Controlador
{
    ...
    public function Administrar($peticion = null)
    {
        ...
        switch ($peticion) {
            case 'Registros':$this->vista->Cargar_Vistas('inventario_medicina/registrar');break;
            case 'Consultas':$this->vista->Cargar_Vistas('inventario_medicina/consultar');break;
