  ...
  public function consultar_informacion_persona()
  {
    ...
    foreach ($personas as $p) {
      ...
      $info_completa[] = [
        ...
        "telefono"        => $p['telefono'],
        "genero"          => $genero,
        "ver"             => "<button class='btn' style='background:#15406D;color:white' type='button' title='Ver información de la persona' onclick='ver_datos(`" . $persona . "`,`" . $ocupacion . "`,`" . $condicion_lab . "`,`" . $transporte . "`,`" . $bonos . "`,`" . $misiones . "`,`" . $proyectos . "`,`" . $comunidad_i . "`,`" . $org_politica . "`)'><span class='fa fa-eye'></span></button>",

        "editar"             => "<button class='btn' style='background:#EEA000;color:white' type='button' title='Editar información de la persona' onclick='editar_datos(`" . $persona . "`,`" . $ocupacion . "`,`" . $condicion_lab . "`,`" . $transporte . "`,`" . $bonos . "`,`" . $misiones . "`,`" . $proyectos . "`,`" . $comunidad_i . "`,`" . $org_politica . "`)'><span class='fa fa-edit'></span></button>",
