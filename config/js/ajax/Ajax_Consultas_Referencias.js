$(function() {
    $.ajax({   
        ...
        $("#example1").on("click", ".mensaje-eliminar", function() {
            ...
            var estado = {
                tabla: "referencias_medicas",
                id_tabla: "id_referencia",
                param: id,
                estado: 0
            };
            swal({
                title: "¿Desea eliminar ésta referencia?",
                ...
                if (isConfirm) {
                    $.ajax({
                        ...
                        data: {
                            ...
                            estado: estado,
                            sql: "ACT_DES",
                            accion: "Se ha eliminado la referencia: "+fila.find("td:eq(2)").text(),
                        },
                    ...
                    swal({                             
                        title: "Cancelado",
                        text: "La acción fue cancelada, la información está segura.",
