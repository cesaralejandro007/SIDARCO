document.getElementById("button-addon").onclick = function(){
    if(document.getElementById("fechad").value !="" && document.getElementById("fechah").value!=""){
      ...
      if(document.getElementById("fechad").value <= document.getElementById("fechah").value){
        ...
        tabla = '<table id="example2" class="table table-striped table-hover table-responsive border">'+
        '<thead>'+
  ...
  document.getElementById("button-addon1").onclick = function(){
    if(document.getElementById("fechaselect").value !="0"){
      ...
      tabla = '<table id="example3" class="table table-striped table-hover table-responsive border">'+
      '<thead>'+
         '<th style="width:80px;">Cedula</th>'+
         '<th>Primer Nombre</th>'+
         '<th>Segundo Nombre</th>'+
  ...
  Swal.fire({
      ...
      $("#consultarcumplañeros").modal('show');
        cargar_tabla_personas2(fechaselects); 
