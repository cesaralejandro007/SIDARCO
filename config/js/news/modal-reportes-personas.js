...
document.getElementById("button-addon").onclick = function(){
  ...
  return searchString.length? "Search: " + searchString : "Ingresados a nómina, desde: " +fechat1 + " hasta: "+ fechat2
  },
...
customize: function ( doc ) {
 ...
 cols[0] = {        
  ...
  width: 150,
  height: 50};
  cols[1] = {text: "Reporte de los funcionarios ingresados a nómina, desde: " +fechat1 + " hasta: "+ fechat2, alignment: 'start', margin:[20, 20, 20, 20 ] };
 var objFooter = {};
  ...
  document.getElementById("button-addon1").onclick = function(){
    if(document.getElementById("fechaselect").value !="0"){
      fechaselects = document.getElementById("fechaselect").value;
        if(fechaselects == '01'){
          fechaactual = "Enero"
        }else if(fechaselects == '02'){
          fechaactual = "Febrero"
        }else if(fechaselects == '03'){
          fechaactual = "Marzo"
        }else if(fechaselects == '04'){
          fechaactual = "Abril"
        }else if(fechaselects == '05'){
          fechaactual = "Mayo"
        }else if(fechaselects == '06'){
          fechaactual = "Junio"
        }else if(fechaselects == '07'){
          fechaactual = "Julio"
        }else if(fechaselects == '08'){
          fechaactual = "Agosto"
        }else if(fechaselects == '09'){
          fechaactual = "Septiembre"
        }else if(fechaselects == '10'){
          fechaactual = "Octubre"
        }else if(fechaselects == '11'){
          fechaactual = "Noviembre"
        }else if(fechaselects == '12'){
          fechaactual = "Diciembre"
        }
...
customize: function ( doc ) {
 ...
 cols[0] = {        
  ...
  width: 150,
  height: 50};
  cols[1] = {text: "Reporte de los cumpleañeros del mes de " + fechaactual, alignment: 'start', margin:[50, 20, 20, 20 ] };
 var objFooter = {};
 objFooter['columns'] = cols;
 doc['header']=objFooter;
  // Splice the image in after the header, but before the table
  ...
  extend:    'excelHtml5',
  filename: function() {
  return "EXCEL-Nómina-"+document.getElementById('valor'+document.getElementById('nominaavanzada').value).value     
  },          
  title: function() {
  var searchString = table.search();        
  ...
  pageSize: 'LETTER',
  filename: function() {
  return "PDF-Nómina-"+document.getElementById('valor'+document.getElementById('nominaavanzada').value).value   
  },
  title: function() {
    var searchString = table.search();        
    return searchString.length? "Search: " + searchString : ""
  ...
  customize: function ( doc ) {
   ...
   cols[0] = {        
    ...
    width: 150,
    height: 50};
    cols[1] = {text: "Reporte de la Nómina de " + document.getElementById('valor'+document.getElementById('nominaavanzada').value).value, alignment: 'start', margin:[80, 20, 20, 20 ] };
   var objFooter = {};
   objFooter['columns'] = cols;
   doc['header']=objFooter;
    // Splice the image in after the header, but before the table
...
customize: function ( doc ) {
 ...
 cols[0] = {        
  ...
  width: 150,
  height: 50};
  cols[1] = {text: "Reporte de la Nómina de " + document.getElementById('valor'+document.getElementById('nominaavanzada').value).value, alignment: 'start', margin:[70, 20, 20, 20 ] };
 var objFooter = {};
 objFooter['columns'] = cols;
 doc['header']=objFooter;
  // Splice the image in after the header, but before the table
