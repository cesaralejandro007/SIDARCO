...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Historial del Funcionario</h1>
                </div><!-- /.col -->
                <!-- /.col --> 
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class=" d-flex flex-wrap justify-content-center">
                                        <div style="" class="m-1">
                                            <input type="text" id="Cedulaf" class="form-control" placeholder="Cedula" data-index="1">
                                        </div>
                                        <div style="" class="m-1">
                                            <input type="text" id="Nombref" class="form-control" placeholder="Nombre" data-index="2">
                                        </div>
                                        <div style="" class="m-1">
                                            <input type="text" id="Apellidof" class="form-control" placeholder="Apellido" data-index="3">
                                        </div>
                                        <div style="" class="m-1">
                                            <input type="text" id="Observf" class="form-control" placeholder="Observación" data-index="4">
                                        </div>
                                        <div style="" class="m-1">
                                            <input type="text" id="fechaF" class="form-control" placeholder="Fecha y Hora" data-index="5">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <table id="example1" class="table table-striped table-hover border" style="width:100%">
                    <thead>
                        <tr>
 ...
 function cargar_tabla_personas(){
   ...
   $.ajax({
    type: 'POST',
    url: BASE_URL + 'Personas/consultar_informacion_persona_historia'
}).done(function(datos) {
    ...
    var table = $("#example1").DataTable({
      ...
      fixedHeader: true,    
        ...
        {
            data:"descrip_historial_funcionario"
        },
        {
            data:"fecha_historial_funcionario"
        },
        ],
        responsive: true,
        autoWidth: false,
        ...
        buttons:[ 
    {
      extend:    'excelHtml5',
      filename: function() {
        return "EXCEL-Personas-historial"      
      },          
      title: function() {
        var searchString = table.search();        
        return searchString.length? "Search: " + searchString : "Reporte del historial de los funcionarios"
      },
    ...
    width: 150,
    height: 50};
    cols[1] = {text: "Reporte del historial de los funcionarios", alignment: 'start', margin:[85, 20, 20, 20 ] };
    var objFooter = {};
...
fechaF
    ...
    table.column($(this).data('index')).search(this.value).draw();
     ...
     $("#Observf").keyup(function() {
    table.column($(this).data('index')).search(this.value).draw();
    });
    $("#fechaF").keyup(function() {
    table.column($(this).data('index')).search(this.value).draw();
    });    
}).fail(function() {
    alert("error")
