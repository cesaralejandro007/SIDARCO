...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Consulta de Egresos</h1>
                </div><!-- /.col -->
                <!-- /.col --> 
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
 ...
 function cargar_tabla_personas(){
   ...
   $.ajax({
        ...
        buttons:[ 
    {
      extend:    'excelHtml5',
      filename: function() {
        return "EXCEL-Personas-Egresos"      
      },          
      title: function() {
        var searchString = table.search();        
        return searchString.length? "Search: " + searchString : "Reporte de Personas Egresadas"
      },
    ...
    width: 150,
    height: 50};
    cols[1] = {text: "Reporte de Personas Egresadas", alignment: 'start', margin:[90, 20, 20, 20 ] };
    var objFooter = {};
