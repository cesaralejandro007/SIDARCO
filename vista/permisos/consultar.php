                            ...
                            $(function(){
                                $.ajax({
                                    ...
                                    var table = $("#example1").DataTable({
                                        ...
                                        {
                                            "data": "dias_de_permisos"
                                        },
                                        {
                                            "data": "semanas_de_permisos"
                                        },
                                        {
                                            "data": "fecha_pro"
                                        },
                                        ...
                                        extend:    'excelHtml5',
                                        filename: function() {
                                            return "EXCEL-Permisos"      
                                        },          
                                        title: function() {
                                            var searchString = table.search();        
                                            return searchString.length? "Search: " + searchString : "Reporte de Permisos"
                                        },
                                        ...
                                        width: 150,
                                        height: 50};
                                        cols[1] = {text: "Reporte de Permisos", alignment: 'start', margin:[95, 20, 20, 20 ] };
                                        var objFooter = {};
