    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Registrar Resposo</h4>
            ...
            <!--      /.card-body  -->
                <div class="card-footer">
                    <div class="text-center m-t-20">
                        <div class="col-xs-12">
                            <input type="button" class="btn" style="background:#15406D; color:white" name="" id="enviarReposo" value="Guardar">
...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
                <button id="btn_registrar" class="btn btn-primary" type="button">Registrar reposo</button>
            <div class="col-lg-12">
                    ...
                    <thead>
                        <tr>
                            ...
                            $(function(){
                                $.ajax({
                                    type: 'POST',
                                    url: BASE_URL + 'reposos/consultar_info_reposos'
                                }).done(function(datos) {
                                    ...
                                    fixedHeader: true,    
                                        ...
                                        extend:    'excelHtml5',
                                        filename: function() {
                                            return "EXCEL-Reposos"      
                                        },          
                                        title: function() {
                                            var searchString = table.search();        
                                            return searchString.length? "Search: " + searchString : "Reporte de Reposos"
                                        },
                                        ...
                                        width: 150,
                                        height: 50};
                                        cols[1] = {text: "Reporte de Reposos", alignment: 'start', margin:[95, 20, 20, 20 ] };
                                        var objFooter = {};
...
<?php include modal."editar-reposo.php"; ?> 
<!-- /.content-wrapper -->
...
<script type="text/javascript" src="<?php echo constant('URL')?>config/js/news/consultar-reposos.js"></script>
